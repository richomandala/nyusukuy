    ...
    <div class="card-body">
        <form id="form">
            ...
            <div class="form-group">
                ...
                <select name="supplier_id" id="supplier_id" class="form-control" data-value="<?= $pembelian['supplier_id']; ?>">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="keterangan" name="keterangan" placeholder="Masukkan keterangan" rows="3" required><?= $pembelian['keterangan']; ?></textarea>
            </div>
            <div class="form-group">
