    ...
    <div class="card-body">
        <form id="form">
            <div class="form-group">
                <label>Produk</label>
                <input type="text" class="form-control" id="produk" name="produk" placeholder="Masukkan produk" required>
            </div>
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" id="harga" name="harga" step="any" min="1" placeholder="Masukkan harga" required>
                </div>
            </div>
            <div class="form-group">
